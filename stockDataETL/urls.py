...
import test
from stockDataETL.run import InitDatabase, DailyTask, AsyncDailyTask, OneNightStockTask, OneNightStockHistoryTask, PeriodicTask
...
urlpatterns = [
    ...
    path('PeriodicTask/', PeriodicTask.periodicTask, name='PeriodicTask'),
