    ...
    text("""
        ...
        from (
            ...
            where ods_trade_cal.is_open = 1
              and dm_daily_one_night_stock.update_time < '2025-12-24'
        ) a left join (
            select
                ts_code,
                trade_date,
...
getTSData = GetTSData()
cal_data = getTSData.getTradeCal(start_date="20260101", end_date="20261231")
cal_data.to_sql("ods_trade_cal", con=engine, if_exists="append", index=False)