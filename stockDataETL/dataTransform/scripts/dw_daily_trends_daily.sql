...
select
    ...
    ROUND(((ods_daily.open - ods_daily.pre_close) / ods_daily.pre_close),4) * 100 as open_pct_chg,
    ROUND(((ods_daily.high - ods_daily.pre_close) / ods_daily.pre_close),4) * 100 as high_pct_chg,
    ROUND(((ods_daily.low - ods_daily.pre_close) / ods_daily.pre_close),4) * 100 as low_pct_chg,
    ...
    ROUND(((ods_moneyflow.buy_elg_amount - ods_moneyflow.sell_elg_amount) / net_mf_amount),4) * 100 as buy_elg_net_amount_rate,
    ods_moneyflow.buy_lg_amount - ods_moneyflow.sell_lg_amount as buy_lg_net_amount,
    ROUND(((ods_moneyflow.buy_lg_amount - ods_moneyflow.sell_lg_amount) / net_mf_amount),4) * 100 as buy_lg_net_amount_rate,
    ods_moneyflow.buy_md_amount - ods_moneyflow.sell_md_amount as buy_md_net_amount,
    ROUND(((ods_moneyflow.buy_md_amount - ods_moneyflow.sell_md_amount) / net_mf_amount),4) * 100 as buy_md_net_amount_rate,
    ods_moneyflow.buy_sm_amount - ods_moneyflow.sell_sm_amount as buy_sm_net_amount,
    ROUND(((ods_moneyflow.buy_sm_amount - ods_moneyflow.sell_sm_amount) / net_mf_amount),4) * 100 as buy_sm_net_amount_rate,
