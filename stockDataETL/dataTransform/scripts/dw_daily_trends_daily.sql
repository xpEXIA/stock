...
select
    ...
    ROUND(((ods_daily.open - ods_daily.pre_close) / ods_daily.pre_close),2) as open_pct_chg,
    ROUND(((ods_daily.high - ods_daily.pre_close) / ods_daily.pre_close),2) as high_pct_chg,
    ROUND(((ods_daily.low - ods_daily.pre_close) / ods_daily.pre_close),2) as low_pct_chg,
